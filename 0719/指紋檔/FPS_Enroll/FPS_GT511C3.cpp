...
byte* Command_Packet::GetPacketBytes() //Command_Packet.GetPacketBytes()
{
	byte* packetbytes= new byte[12];//packetbytes 新的12byte
...
void FPS_GT511C3::Open()
{
	...
	cp->Command = Command_Packet::Commands::Open;//cp
	cp->Parameter[0] = 0x00;
	cp->Parameter[1] = 0x00;
	cp->Parameter[2] = 0x00;
	cp->Parameter[3] = 0x00;
